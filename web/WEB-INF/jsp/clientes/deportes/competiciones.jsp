        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <p>&nbsp;<img align="left" src="<c:url value='/resources/imagenes/competiciones/${deporte.idDeporte}.jpg'/>" width="175" height="175"/>
                        Compre entradas para competiciones de ${deporte.nombre}</p><br style="line-height:130px">
                    <hr>
                    <h3>Categorías</h3>
                    <ul>
                        <c:forEach var="competicionesitem" items="${competiciones}">
                            <li><a href="<c:url value='/eventos/verEventosCompeticion/${competicionesitem.idCompeticion}'/>">${competicionesitem.nombre}</a></li>
                        </c:forEach>
                    </ul>
