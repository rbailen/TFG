            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <p>&nbsp;<img align="left" src="<c:url value='/resources/imagenes/deportes/${deporte.idDeporte}.jpg'/>" width="175" height="175"/>
                        Compre entradas para ${deporte.denominacionEvento} de ${deporte.nombre}</p><br style="line-height:130px">
                    <hr>
                    <h3>Categorías</h3>
                    <ul>
                        <li><a href="<c:url value='/deportes/ver${deporte.denominacionParticipante}/${deporte.idDeporte}'/>">${deporte.denominacionParticipante}</a></li>
                        <li><a href="<c:url value='/deportes/verCompeticiones/${deporte.idDeporte}'/>">Competiciones</a></li>
                        <li><a href="<c:url value='/eventos/verEventosDeporte/${deporte.idDeporte}'/>">Catálogo de ${deporte.denominacionEvento} disponibles</a></li>
                    </ul>
                    <a href="<c:url value='/deportes/listado'/> "class="btn btn-primary" role="button">Volver</a>
                </div>
