        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <p>&nbsp;<img align="left" src="<c:url value='/resources/imagenes/part/${participanteEvento.idParticipante}.jpg'/>" width="175" height="175"/>
                        Compre entradas para ${participanteEvento.nombre}</p><br style="line-height:130px">
                    <hr>
                    <h3>Próximos Eventos</h3>
                    <c:if test="${empty eventosParticipante}">
                        <center>EN ESTOS MOMENTOS NO HAY EVENTOS DISPONIBLES PARA COMPRAR ENTRADAS DE ESTE PARTICIPANTE</center>
                    </c:if>
                    <c:if test="${not empty eventosParticipante}">
                        <c:forEach var="eventositem" items="${eventosParticipante}">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="jumbotron" style="background: palegoldenrod">
                                            ...
                                            ${eventositem.lugar}, ${eventositem.ciudad}, ${eventositem.pais.nombre}<br>
                    ...
                    <a href="<c:url value='/deportes/ver${deporte.denominacionParticipante}/${deporte.idDeporte}'/> "class="btn btn-primary" role="button">Volver</a>
