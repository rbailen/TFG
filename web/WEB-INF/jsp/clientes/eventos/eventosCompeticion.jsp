        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <p>&nbsp;<img align="left" src="<c:url value='/resources/imagenes/comp/${competicionEvento.idCompeticion}.jpg'/>" width="175" height="175"/>
                        Compre entradas para ${competicionEvento.nombre}</p><br style="line-height:130px">
                    <hr>
                    <h3>Próximos Eventos</h3>
                    <c:if test="${empty eventosCompeticion}">
                        <center>EN ESTOS MOMENTOS NO HAY EVENTOS DISPONIBLES PARA COMPRAR ENTRADAS DE ESTA COMPETICIÓN</center>
                    </c:if>
                    <c:if test="${not empty eventosCompeticion}">
                        <c:forEach var="eventositem" items="${eventosCompeticion}">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <a href="<c:url value='/deportes/verCompeticiones/${competicionEvento.deporte.idDeporte}'/> "class="btn btn-primary" role="button">Volver</a>
