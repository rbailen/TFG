        ...
        <script type="text/javascript">
            $(function () {
                $('#myModal').on('show.bs.modal', function (event) {
                    ...
                    var idDeporte = button.data('id');
                    var modal = $(this);
                    modal.find('#btEliminar').attr('href', '<c:url value="/deportes/borraDeporte/"/>' + idDeporte);
                });
            });
        </script>
    </head>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <c:if test="${empty deportes}">
                        <center>NO HAY DEPORTES DISPONIBLES</center>
                        </c:if>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <tr class="text-capitalize">
                                    <th>Id</th>
                                    <th>Nombre</th>
                                    <th>Denominación del Participante</th>
                                    <th>Denominación del Evento</th>
                                    <th></th>
                                    <th></th>
                                </tr>
                                <c:forEach var="c" items="${deportes}">
                                    <c:set var="qry" value="${c.idDeporte}"/>
                                    <tr class="table-striped">
                                        <td>${c.idDeporte}</td>
                                        <td>${c.nombre}</td>
                                        <td>${c.denominacionParticipante}</td>
                                        <td>${c.denominacionEvento}</td>
                                        <td>
                                            <a href="<c:url value='/deportes/editaDeporte/${qry}'/>" class="btn btn-primary">
                                                <span class="glyphicon glyphicon-edit"></span>&nbsp;Editar
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" role="button" data-id="${c.idDeporte}" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-trash"></span>&nbsp;Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                        ...
                        <a href="<c:url value='/deportes/altaDeporte'/>" class="btn btn-success">
                            <span class="glyphicon glyphicon-plus"></span>&nbsp;Nuevo Deporte
                        </a>
                </div>
