            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <form:form class="form-horizontal" method="POST" modelAttribute="cliente" >
                        ...
                        <br>
                        <form:radiobutton path="rol" value="ROLE_ADMIN"/>&nbsp;ROL_ADMIN
                        <br>
                        <form:radiobutton path="rol" value="ROLE_USER"/>&nbsp;ROL_USER
                        ...
                        <a href="<c:url value='/usuarios/listadoClientes'/> "class="btn btn-primary" role="button">Volver</a>
                    </form:form>
                </div>
