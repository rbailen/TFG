        ...
        <script type="text/javascript">
            $(function () {
                $('#myModal').on('show.bs.modal', function (event) {
                    ...
                    var idParticipante = button.data('id');
                    var modal = $(this);
                    modal.find('#btEliminar').attr('href', '<c:url value="/participantes/borraParticipante/"/>' + idParticipante);
                });
            });
        </script>
    </head>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <c:if test="${empty participantes}">
                        <center>NO HAY PARTICIPANTES DISPONIBLES</center>
                        </c:if>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <c:forEach var="c" items="${participantes}">
                                    <c:set var="qry" value="${c.idParticipante}"/>
                                    <tr class="table-striped">
                                        <td>${c.idParticipante}</td>
                                        <td>${c.nombre}</td>
                                        <td>${c.deporte.nombre}</td>
                                        <td>
                                            <a href="<c:url value='/participantes/editaParticipante/${qry}'/>" class="btn btn-primary">
                                                <span class="glyphicon glyphicon-edit"></span>&nbsp;Editar
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" role="button" data-id="${c.idParticipante}" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-trash"></span>&nbsp;Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                        ...
                        <a href="<c:url value='/participantes/altaParticipante'/>" class="btn btn-success">
                            <span class="glyphicon glyphicon-plus"></span>&nbsp;Nuevo Participante
                        </a>
                </div>
