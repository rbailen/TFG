        ...
        <script type="text/javascript">
            $(function () {
                $('#myModal').on('show.bs.modal', function (event) {
                    ...
                    var modal = $(this);
                    modal.find('#btEliminar').attr('href', '<c:url value="/eventos/borraEvento/"/>' + idEvento);
                });
            });
        </script>
    </head>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <c:if test="${empty eventos}">
                        <center>NO HAY EVENTOS DISPONIBLES</center>
                        </c:if>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <c:forEach var="c" items="${eventos}">
                                    <c:set var="qry" value="${c.idEvento}"/>
                                    <tr class="table-striped">
                                        ...
                                        <td>
                                            <a href="<c:url value='/eventos/visualizaEvento/${qry}'/>" class="btn btn-warning">
                                        ...
                                        <td>
                                            ...
                                            <c:forEach var="evento" items="${eventosEntradasPuestasVenta}">
                                                <c:if test="${evento.idEvento == c.idEvento}">
                                            ...
                                            <c:if test="${not alaventa}">
                                                <a href="<c:url value='/eventos/editaEvento/${qry}'/>" class="btn btn-primary">
                                        ...
                                        <td>
                                            <a class="btn btn-danger" role="button" data-id="${c.idEvento}" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-trash"></span>&nbsp;Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                    ...
                    <a href="<c:url value='/eventos/altaEvento'/>" class="btn btn-success">
