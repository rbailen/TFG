        ...
        <script type="text/javascript">
            $(function () {
                $('#myModal').on('show.bs.modal', function (event) {
                    ...
                    var idCompeticion = button.data('id');
                    var modal = $(this);
                    modal.find('#btEliminar').attr('href', '<c:url value="/competiciones/borraCompeticion/"/>' + idCompeticion);
                });
            });
        </script>
    </head>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <c:if test="${empty competiciones}">
                        <center>NO HAY COMPETICIONES DISPONIBLES</center>
                        </c:if>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <c:forEach var="c" items="${competiciones}">
                                    <c:set var="qry" value="${c.idCompeticion}"/>
                                    <tr class="table-striped">
                                        <td>${c.idCompeticion}</td>
                                        <td>${c.nombre}</td>
                                        <td>${c.deporte.nombre}</td>
                                        <td>
                                            <a href="<c:url value='/competiciones/editaCompeticion/${qry}'/>" class="btn btn-primary">
                                                <span class="glyphicon glyphicon-edit"></span>&nbsp;Editar
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-danger" role="button" data-id="${c.idCompeticion}" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-trash"></span>&nbsp;Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                    ...
                    <a href="<c:url value='/competiciones/altaCompeticion'/>" class="btn btn-success">
                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Nueva Competición
                    </a>
                </div>
