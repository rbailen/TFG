        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <form:form class="form-horizontal" method="POST" modelAttribute="competicion">
                        <strong>Id Competición: ${competicion.idCompeticion}</strong><br>
                        
                        <form:hidden path="idCompeticion"/>
                        ...
                        <a href="<c:url value='/competiciones/listadoCompeticiones'/> "class="btn btn-primary" role="button">Volver</a>
                    </form:form>
                </div>
